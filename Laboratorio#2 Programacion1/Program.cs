		...
		case 1:
		 ...
		 int bucle = 1;
			while (bucle == 1)
			{
				...
				//Console.WriteLine("Ingrese la nota del tercer labotorio: ");
				//nota.Lab3 = Convert.ToDecimal(Console.ReadLine());
				//double labonota2 = Convert.ToDouble(nota.Lab3);
				//calcularnotas.CalcNotaLab(labonota2);
				...
				//double Parcnota2 = Convert.ToDouble(nota.Parcial2);
				//calcularnotas.CalcNotaParc(Parcnota2);
